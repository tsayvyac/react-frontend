         ...
         <Stack sx={{ width: '100%' }} direction='column' spacing={2}>
            ...
            <Container component={Paper} sx={{ p: 2 }}>
               ...
               <Typography variant='subtitle2' color={theme.palette.text.secondary}>
                  ...
                  communities. This project aims to enhance the quality of public spaces by ensuring that benches, tables, bus stops, and
                  other amenities remain in excellent condition. By doing so, Rechair contributes to a more inviting, comfortable, and
